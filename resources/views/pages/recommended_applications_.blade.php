                                                            ...
                                                            <div class="dropdown-menu">
                                                                <div class="btnJustify2">
                                                                    @if($app->transcript_type == 'PROFICIENCY')
                                                                        <a href="proficiency/{{$app->address}}" target="_blank" type="button" class="btn btn-secondary waves-effect btn-label waves-light"><i class="bx bx-show-alt label-icon"></i>View</a>
                                                                    @else
