                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($app->delivery_mode == 'Hard')<button type="button" data-type="{{$app->transcript_type}}" data-id="{{$app->application_id}}" class="btn btn-success waves-effect btn-label waves-light download"><i class="bx bx-show-alt label-icon"></i>Download PDF</button>@endif
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
